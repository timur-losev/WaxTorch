...
- [x] Add `WaxStore::TryRefreshIfPublishedCommitVisible()` probe API and direct write-path regressions (`step1` no-refresh, `step2/5` refresh) to support orchestrator in-process crash-window recovery
