...
- [x] Add retry-flush regressions for externally visible crash-window commit (`step2`) in text/vector channels: second `Flush()` must behave as no-op while preserving committed visibility
