...
- [x] Add retry-flush regressions for externally visible crash-window commits (`step2` and `step5`) in text/vector channels: second `Flush()` must behave as no-op while preserving committed visibility
