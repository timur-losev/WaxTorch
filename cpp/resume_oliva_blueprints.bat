...
curl -s -X POST http://127.0.0.1:8080/ ^
  ...
  -d "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"index.start\",\"params\":{\"repo_root\":\"%EXPORT_DIR:\=/%\",\"resume\":true,\"flush_every_chunks\":1000,\"ingest_batch_size\":1,\"target_tokens\":3000,\"max_chunks\":0,\"include_extensions\":[\".json\"],\"exclude_dirs\":[],\"enrich_regex\":false,\"enrich_llm\":true}}"
